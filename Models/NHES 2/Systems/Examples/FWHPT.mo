  ...
  equation
    ...
    connect(CTES.Charge_Outlet, Condensate_out.port_a) annotation (Line(points={{-32.3,
            -15.6},{-32.3,-14},{-46,-14},{-46,-34},{-52,-34}},
                                                      color={0,127,255}));
    connect(CTES.Discharge_Inlet, Discharge_Valve.port_b) annotation (Line(points={{23,4.7},
            {62.15,4.7},{62.15,-3},{68,-3}},          color={0,127,255}));
    connect(CTES.Discharge_Outlet, Discharge_out.port_a) annotation (Line(points={{23,
            -14.9},{62,-14.9},{62,-52},{68,-52}},          color={0,127,255}));
