...
model SteamTurbine_L2_ClosedFeedHeat_AdditionalFeedheater_Deaerator_2
  "Two stage BOP model"
  ...
  Fluid.HeatExchangers.Generic_HXs.NTU_HX_SinglePhase MainFeedwaterHeater2(
    ...
    m_start_tube=80,
    m_start_shell=5)
    annotation (Placement(transformation(extent={{162,-178},{182,-158}})));
  ...
  Modelica.Blocks.Sources.Constant const2(k=0)
    annotation (Placement(transformation(extent={{-162,-128},{-154,-120}})));
  Modelica.Blocks.Math.Add         add2
    annotation (Placement(transformation(extent={{-138,-126},{-118,-106}})));
  Modelica.Blocks.Sources.RealExpression
                                   realExpression(y=deaerator.medium.p)
    annotation (Placement(transformation(extent={{-300,-124},{-286,-112}})));
  ...
  StagebyStageTurbineSecondary.Control_and_Distribution.Timer             timer(
      Start_Time=1e-2)
    annotation (Placement(transformation(extent={{-162,-114},{-154,-106}})));
  Modelica.Blocks.Sources.Constant const3(k=142000)
    annotation (Placement(transformation(extent={{-164,-156},{-178,-142}})));
...
equation
  ...
  connect(deaerator.feed,sensor_T3. port_a) annotation (Line(points={{103,-147},
          {103,-134},{102,-134}},         color={0,127,255}));
  connect(Pump_Speed.y, pump_SimpleMassFlow1.inputSignal) annotation (Line(
        points={{167.3,-121},{136,-121},{136,-127}}, color={0,0,127}));
  connect(R_feedwater2.port_b, MainFeedwaterHeater2.Shell_in)
    annotation (Line(points={{149,-170},{162,-170}}, color={0,127,255}));
  connect(MainFeedwaterHeater2.Shell_out, port_b1) annotation (Line(points={{
          182,-170},{186,-170},{186,-190},{-12,-190},{-12,-174},{-10,-174},{-10,
          -146},{-24,-146},{-24,-160}}, color={0,127,255}));
  connect(pump_SimpleMassFlow1.port_b, sensor_T3.port_b)
    annotation (Line(points={{126,-134},{122,-134}}, color={0,127,255}));
  connect(firstfeedpump2.port_b, MainFeedwaterHeater2.Tube_in) annotation (Line(
        points={{180,-152},{180,-160},{182,-160},{182,-164}}, color={0,127,255}));
  connect(firstfeedpump2.port_a, Condenser.port_b) annotation (Line(points={{
          200,-152},{190,-152},{190,-108},{160,-108}}, color={0,127,255}));
  connect(MainFeedwaterHeater2.Tube_out, FeedwaterMixVolume4.port_a[1])
    annotation (Line(points={{162,-164},{156,-164},{156,-150},{148,-150}},
        color={0,127,255}));
  connect(FeedwaterMixVolume4.port_b[1], pump_SimpleMassFlow1.port_a)
    annotation (Line(points={{136,-150},{126,-150},{126,-142},{146,-142},{146,
          -134}}, color={0,127,255}));
  connect(realExpression.y,PID1. u_s) annotation (Line(points={{-285.3,-118},{
          -250,-118},{-250,-120},{-212,-120}},
                                      color={0,0,127}));
  connect(PID1.y,timer. u) annotation (Line(points={{-189,-120},{-168,-120},{
          -168,-110},{-162.8,-110}},
                        color={0,0,127}));
  connect(add2.u1,timer. y) annotation (Line(points={{-140,-110},{-153.44,-110}},
                                                                color={0,0,127}));
  connect(const2.y,add2. u2) annotation (Line(points={{-153.6,-124},{-153.6,
          -122},{-140,-122}},
                     color={0,0,127}));
  connect(const3.y, PID1.u_m) annotation (Line(points={{-178.7,-149},{-192,-149},
          {-192,-132},{-200,-132}}, color={0,0,127}));
  connect(TCV1.port_b, port_b1) annotation (Line(points={{-28,-124},{-32,-124},
          {-32,-146},{-24,-146},{-24,-160}}, color={0,127,255}));
  connect(MainFeedwaterHeater1.Shell_out, TCV1.port_a) annotation (Line(points=
          {{-10,-48},{-6,-48},{-6,-64},{-10,-64},{-10,-112},{-4,-112},{-4,-124},
          {-12,-124}}, color={0,127,255}));
  connect(MainFeedwaterHeater1.Shell_out, R_feedwater2.port_a) annotation (Line(
        points={{-10,-48},{-6,-48},{-6,-64},{-10,-64},{-10,-112},{-4,-112},{-4,
          -186},{128,-186},{128,-170},{135,-170}}, color={0,127,255}));
  connect(add2.y, TCV1.opening) annotation (Line(points={{-117,-116},{-32,-116},
          {-32,-112},{-20,-112},{-20,-117.6}}, color={0,0,127}));
...
end SteamTurbine_L2_ClosedFeedHeat_AdditionalFeedheater_Deaerator_2;
