...
model
  SteamTurbine_L2_ClosedFeedHeat_AdditionalFeedheater_Deaerator_ThreeStage_OFWH
  "Two stage BOP model"
  ...
  TRANSFORM.Fluid.FittingsAndResistances.SpecifiedResistance R_feedwater3(R=2000,
      redeclare package Medium = Modelica.Media.Water.StandardWater)
    annotation (Placement(transformation(extent={{10,-10},{-10,10}},
        rotation=180,
        origin={238,-164})));
  ...
  Modelica.Blocks.Sources.RealExpression
    ...
    annotation (Placement(transformation(extent={{322,-64},{296,-44}})));
  TRANSFORM.Fluid.Volumes.MixingVolume FeedwaterMixVolume3(
    redeclare package Medium = Modelica.Media.Water.StandardWater,
    p_start=200000,
    use_T_start=false,
    T_start=373.15,
  ...
  Modelica.Blocks.Sources.Ramp ramp2(
    ...
    offset=5e-7,
    startTime=1e4)
    annotation (Placement(transformation(extent={{240,-26},{260,-6}})));
  TRANSFORM.Fluid.Volumes.MixingVolume FeedwaterMixVolume4(
    redeclare package Medium = Modelica.Media.Water.StandardWater,
    p_start=200000,
    use_T_start=false,
    T_start=373.15,
...
equation
  ...
  connect(Pump_Speed.y, pump_SimpleMassFlow1.inputSignal) annotation (Line(
        points={{267.3,-121},{168,-121},{168,-118},{148,-118},{148,-127}},
                                                     color={0,0,127}));
  ...
  connect(sensor_T3.port_b, pump_SimpleMassFlow1.port_b)
    annotation (Line(points={{126,-134},{138,-134}}, color={0,127,255}));
  connect(MainFeedwaterHeater2.Shell_out, port_b1) annotation (Line(points={{212,
          -194},{224,-194},{224,-168},{178,-168},{178,-160},{130,-160}},
                                                       color={0,127,255}));
  ...
  connect(PID1.y, timer.u) annotation (Line(points={{263,-54},{252,-54},{252,-42},
          {238.8,-42}},      color={0,0,127}));
  connect(FeedwaterMixVolume2.port_b[1], R_feedwater3.port_a) annotation (Line(
        points={{190,-106},{190,-164},{231,-164}},            color={0,127,255}));
  connect(firstfeedpump1.port_b, MainFeedwaterHeater2.Tube_in)
    annotation (Line(points={{256,-188},{212,-188}}, color={0,127,255}));
  connect(firstfeedpump2.port_b, FeedwaterMixVolume3.port_a[1]) annotation (
      Line(points={{302,-188},{300,-188},{300,-187.75},{296,-187.75}}, color={0,
          127,255}));
  connect(R_feedwater3.port_b, FeedwaterMixVolume3.port_a[2]) annotation (Line(
        points={{245,-164},{299,-164},{299,-188.25},{296,-188.25}}, color={0,127,
          255}));
  connect(FeedwaterMixVolume3.port_b[1], firstfeedpump1.port_a)
    annotation (Line(points={{284,-188},{276,-188}}, color={0,127,255}));
  connect(ramp2.y, PID1.prop_k) annotation (Line(points={{261,-16},{266,-16},{266,
          -42.6},{266.6,-42.6}}, color={0,0,127}));
  connect(realExpression1.y, PID1.u_s)
    annotation (Line(points={{294.7,-54},{286,-54}}, color={0,0,127}));
  connect(PID1.u_m, sensorW.W) annotation (Line(points={{274,-66},{178,-66},{
          178,11},{208,11}}, color={0,0,127}));
  connect(FeedwaterMixVolume4.port_a[1], MainFeedwaterHeater2.Tube_out)
    annotation (Line(points={{178,-178},{185,-178},{185,-188},{192,-188}},
        color={0,127,255}));
  connect(FeedwaterMixVolume4.port_b[1], pump_SimpleMassFlow1.port_a)
    annotation (Line(points={{166,-178},{166,-134},{158,-134}}, color={0,127,
          255}));
