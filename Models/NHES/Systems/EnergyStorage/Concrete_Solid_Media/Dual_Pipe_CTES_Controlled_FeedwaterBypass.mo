...
model Dual_Pipe_CTES_Controlled_FeedwaterBypass
...
equation
  ...
  connect(ramp1.y, boundary1.p_in) annotation (Line(points={{-47,-82},{6,-82},{
...
end Dual_Pipe_CTES_Controlled_FeedwaterBypass;
