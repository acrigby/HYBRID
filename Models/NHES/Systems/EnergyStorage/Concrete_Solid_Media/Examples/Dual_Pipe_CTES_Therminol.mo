...
equation
  ...
  connect(CTES.Charge_Outlet, Condensate_out.port_a) annotation (Line(points={{-26.3,
          -5.6},{-26.3,28},{14,28},{14,58},{18,58}},color={0,127,255}));
  connect(CTES.Discharge_Inlet, Discharge_Valve.port_b) annotation (Line(points={{28.3,
          -7.7},{68.15,-7.7},{68.15,7},{74,7}},     color={0,127,255}));
  connect(CTES.Discharge_Outlet, Discharge_out.port_a) annotation (Line(points={{29,14.7},
          {-12,14.7},{-12,-28},{-28,-28}},               color={0,127,255}));
