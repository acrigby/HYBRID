...
model CS_Rankine_Primary_2
  ...
  Modelica.Blocks.Sources.Constant const2(k=6000000)
...
equation
  ...
  connect(actuatorBus.PR_Compressor, Blower_Speed.y) annotation (Line(
      ...
      pattern=LinePattern.Dash,
      thickness=0.5));
  connect(sensorBus.primarypressure, Blower_Speed.u_m) annotation (Line(
      points={{-30,-100},{-30,-58},{-84,-58},{-84,22},{-26,22},{-26,16}},
      color={239,82,82},
      pattern=LinePattern.Dash,
      thickness=0.5), Text(
      string="%first",
